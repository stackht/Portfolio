...
export function TypingKeyboard({
  className,
  autoTypeText = "Lets build something great together. Open to internships, research, and ambitious engineering problems. Reach out at hello dot hemant dot dev       ",
  typingSpeed = [40, 120],
  scale = 0.8,
  accentColor = "#3b82f6",
